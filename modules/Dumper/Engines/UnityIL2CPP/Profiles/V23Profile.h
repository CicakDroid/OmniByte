#pragma once
// ── Profiles/V23Profile.h ───────────────────────────────────────
// IL2CPP metadata version 23 (Unity 2019.2–2019.4).
// Source: Perfare/Il2CppDumper @ master, Il2Cpp/MetadataClass.cs
// Header: V22 + windowsRuntimeTypeNames (Min=23)
// Structs: minus delegateWrapper/marshaling/ccw/guid (Max=22, V23 > 22)
...
class V23Profile : public IEngineProfile {
public:
    std::string version() const override { return "23"; }

    uint64_t offsetOf(const std::string& key) const override {
        // V23 header: V22 + windowsRuntimeTypeNames (Min=23)
        ...
        static const std::unordered_map<std::string, uint64_t> kOffsets = {
            ...
            // rgctxEntries (Max=24.1, present for V23 since 23 <= 24.1)
            ...
            // windowsRuntime (Min=23, present for V23 since 23 >= 23)
    ...
    size_t structSize(const std::string& key) const override {
        // V23 structs: has customAttributeIndex (Max=24), rgctx (Min=21, Max=24.1)
        // delegateWrapper/marshalingFunctions REMOVED (Max=22, V23 > 22)
        // ccwFunction/guid REMOVED (Max=22, V23 > 22)
        // src: Il2CppDumper/Il2Cpp/MetadataClass.cs @ master (4741d46)
        static const std::unordered_map<std::string, size_t> kSizes = {
            {"Il2CppTypeDefinition",  0x78}, // has customAttributeIndex + rgctx, no delegateWrapper/marshaling/ccw/guid
    ...
    bool validate(const uint8_t* headerBytes, size_t len) const override {
        ...
        return magic == 0xFAB11BAF && ver == 23;
    }
};

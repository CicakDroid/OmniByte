#pragma once
// ── Profiles/V18Profile.h ───────────────────────────────────────
// IL2CPP metadata version 18 (Unity 2017.1).
// Source: Perfare/Il2CppDumper @ master, Il2Cpp/MetadataClass.cs
// Header: Same as V16/V17 — no version-gated fields differ at version 18.
...
class V18Profile : public IEngineProfile {
public:
    std::string version() const override { return "18"; }

    uint64_t offsetOf(const std::string& key) const override {
        // V18 header: identical layout to V16/V17 — no version-gated additions at v18.
        ...
        static const std::unordered_map<std::string, uint64_t> kOffsets = {
            ...
            // rgctxEntries (Max=24.1, present for V18 since 18 <= 24.1)
    ...
    size_t structSize(const std::string& key) const override {
        // V18 structs: identical to V16/V17 — same version-gated fields apply
        // src: Il2CppDumper/Il2Cpp/MetadataClass.cs @ master (4741d46)
    ...
    bool validate(const uint8_t* headerBytes, size_t len) const override {
        ...
        return magic == 0xFAB11BAF && ver == 18;
    }
};

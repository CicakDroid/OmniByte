#pragma once
// UnityIL2CPP — IL2CPP metadata resolver (merged from Dumper1 + UnityIL2CPP).
// Combines static binary analysis (ELF/PE/Mach-O/NSO/WASM) with runtime symbol resolution.
...
public:
    ...
    // ══════════════════════════════════════════════════════════
    // Static Binary Analysis (from Dumper1Resolver)
    // ══════════════════════════════════════════════════════════
...
private:
    ...
    // ══════════════════════════════════════════════════════════
    // Runtime Symbol Resolution (from UnityIL2CPP)
    // ══════════════════════════════════════════════════════════
    static DumpData resolveSymbols(const AnalysisTarget& target,
        ...
        resolveIL2CPPApiSymbols(result);
        resolveMetadataPointer(result, profile);

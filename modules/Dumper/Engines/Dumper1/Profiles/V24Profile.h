...
public:
    ...
    uint64_t offsetOf(const std::string& key) const override {
        // Metadata header field offsets (relative to metadata start).
        // il2cpp-dumper-rs: metadata.header.stringLiteralOffset etc.
    ...
    size_t structSize(const std::string& key) const override {
        // il2cpp-dumper-rs: Il2CppTypeDefinition, Il2CppMethodDefinition, etc.
        ...
        if (key == "Il2CppTypeDefinition_Count") return 0;
        return 0;
    }

...
// UE 5.6 — same FChunkedFixedUObjectArray layout as 5.3–5.5.
//
// Note: Dumper-7 added bIsNewUE5EnumNamesContainer detection for 5.6+
// (separate FName*/UTF8Char* and int64* value arrays in UEnum).
// This affects enum dumping, not the core struct offsets.
//
// Source: Encryqed/Dumper-7 @ main, OffsetFinder.cpp (InializeUEnumSettings)
//         UE4SS-RE/RE-UE4SS @ main
// Coverage: UE5.6 fully covered.
...
public:
    ...
    uint64_t offsetOf(const std::string& key) const override {
        // Same default layout as UE5.3 — no core struct changes in 5.6
        ...
        static const std::unordered_map<std::string, uint64_t> kOffsets = {
            ...
            // UE5.6+: UEnum uses separate FName*/value arrays
            // src: Dumper-7/OffsetFinder.cpp @ main, InializeUEnumSettings()

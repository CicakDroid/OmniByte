...
class Unigine2_16Profile : public IEngineProfile {
public:
    std::string version() const override { return "2.16"; } // versi terlawas yg masih didukung

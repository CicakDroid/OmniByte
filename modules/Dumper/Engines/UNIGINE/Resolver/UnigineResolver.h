#pragma once
// UNIGINE — implementasi resolveSymbols() yang dipisah dari engine.
// Resolver butuh live process -- resolve Engine::get() / class registry
...
class UnigineResolver {
public:
    // resolve Engine::get() / class registry via live process

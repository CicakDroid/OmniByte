#pragma once
// ── Profiles/CryEngine5_2Profile.h ────────────────────────────────
...
class CryEngine5_2Profile : public IEngineProfile {
public:
    std::string version() const override { return "5.2"; } // versi terlawas yg masih didukung

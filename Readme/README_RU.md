...
<p align="center">
  ...
  Декомпилятор &bull; Редактор &bull; Дампер &bull; Хукинг &bull; Редактор памяти &bull; Монитор сети
</p>
...
Инструментарий предназначен для статического и динамического анализа, декомпиляции, редактирования бинарников, хукинга функций, редактирования памяти, а также мониторинга и редактирования сетевых пакетов — всё в одной интегрированной платформе.
...
| 🌐 **Монитор сетевых пакетов** | Мониторинг сетевого трафика в реальном времени |
| 📝 **Редактор сетевых пакетов** | Перехват и редактирование сетевых пакетов в реальном времени |

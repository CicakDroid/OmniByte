...
<p align="center">
  <strong>Инструмент обратного инженеринга Android</strong><br/>
  Декомпилятор &bull; Редактор &bull; Дампер &bull; Hooking &bull; Редактор памяти &bull; Мониторинг сети
</p>

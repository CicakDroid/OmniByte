...
Инструментарий предназначен для статического и динамического анализа, декомпиляции, редактирования бинарников, хукинга функций, редактирования памяти, а также мониторинга, захвата и редактирования сети — всё в одной интегрированной платформе.
